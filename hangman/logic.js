...
//if you wanted to organize game like an object literal
...
function startGame() {
    console.log(randomProperty(Hgame.artists), '**random prop')
...
function checkLetters(letter) {
  ...
  // If the letter doesn't exist at all...
      ...
      //we check to see if the letter has aready been guessed
      var alreadyGuessed = wrongGuesses.indexOf(letter);
      if (alreadyGuessed >= 0) {
         //we already guessed it, must be an accidet, don't do anything
         return;
      } else {
        // we haven't guessed it..then we add the letter to the list of wrong letters, and we subtract one of the guesses.
